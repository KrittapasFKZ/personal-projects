...
public class TerminalsSolver implements FeatureManager.Feature {
    ...
    public void initClient() {
        UseEntityCallback.EVENT.register((player, world, hand, entity, hitResult) -> {
            if (!enabled || !DUNGEON.inDungeon || !TerminalsSolver.openOnce.isEnabled()) return ActionResult.PASS;
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            else if (currentOverlay != null && client.currentScreen instanceof HandledScreen) {
                currentOverlay.tick();
            }
        });
    }
