...
public class TerminalScreen {
    ...
    public void tick() {
        ...
        if (client.player != null && TerminalsSolver.debug.isEnabled()) {
            ...
            client.gui.setOverlayMessage(Component.literal(debugMsg), false);
        }
    }
    ...
    private void sendMelodySkipPacket(int slot, long delayMs) {
        CompletableFuture.runAsync(() -> {
            ...
            if (client != null && client.player != null) {
                client.execute(() -> {
                    if (client.screen != null && client.gameMode != null && client.screen.getTitle().getString().contains("Click the button on time!")) {
