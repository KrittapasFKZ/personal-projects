            ...
            if (raw.contains("Ice Spray Wand") || (raw.contains("Skeleton Master Chestplate") && DungeonRunOverview.dungeonFloor.contains("7"))) {
                ...
                if (!exists) {
                    ...
                    if (client.player != null) {
                        ...
                        client.gui.getChat().addClientSystemMessage(Component.literal("§e§m§l--------------------------------§r"));
                        client.gui.getChat().addClientSystemMessage(Component.literal("§d§lNA §f§l» §d§lRARE DROP! ").append(name));
                        client.gui.getChat().addClientSystemMessage(Component.literal("§d§m§l--------------------------------§r"));

                        if (DungeonMobDrops.showTitle.isEnabled()) {
                            client.gui.setTitle(Component.literal("§e§l§kA§r §d§lRARE DROP §6§l§kA§r"));
                            client.gui.setSubtitle(name);
