...
public class ModMenuList extends Screen {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(
                Button.builder(Component.literal("Open HUD Editor"), btn ->
                                this.minecraft.setScreen(new EditHudScreen(this)))
    ...
    public void extractRenderState(GuiGraphicsExtractor context, int mouseX, int mouseY, float delta) {
        ...
        for (String fullKey : itemsToDisplay) {
            ...
            context.text(this.font, Component.literal(textPrefix + displayKey), mainX + 12 + textOffsetX, currentY + 3, color, true);
