...
public class NozomiAddonClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        LOGGER.info("NozomiAddon initialized for Minecraft 26.2.x!");
                        ...
                        new Thread(() -> {
                            ...
                            Minecraft.getInstance().execute(() -> {
                                if (ClickGUI.displayMode.getMode().equals("V2")) {
                                    Minecraft.getInstance().gui.setScreen(new ModMenuGrid());
                                } else {
                                    Minecraft.getInstance().gui.setScreen(new ModMenuList());
                                }
                            });
                        }, "na-open-delay").start();
                        return 1;
